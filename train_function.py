...
from segment_anything.modeling import image_encoder, mask_decoder
from segment_anything.build_sam import sam_model_registry
from utils.losses import get_lr_scheduler, set_optimizer_lr, weights_init
from utils.callbacks import LossHistory, EvalCallback
from utils.dataloader import SAMAdaDataset, deeplab_dataset_collate
from utils.utils import download_weights, show_config, seed_everything, worker_init_fn
...
def train(model_path, ver='vit_h'):
    # ---------------------------------#
    #   Cuda    是否使用Cuda
    #           没有GPU可以设置成False
    # ---------------------------------#
    ...
    if local_rank == 0:
        ...
        log_dir = os.path.join(save_dir, f"model_{time_str}")
        save_dir = log_dir
    ...
    if True:
        ...
        dataset_2019_path = '../datasets/2019'
        ...
        if local_rank == 0:
            show_config(
                dataset_dir=dataset.dataset_path, num_classes=num_classes, backbone=backbone, model_path=model_path, input_shape=input_shape, output_shape=output_shape, \
